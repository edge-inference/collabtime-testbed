...
| N | mode | Completion | Throughput (tps) | Avg lat (s) | P90 lat (s) | Util | T_claim (ms) | AoI (ms) |
|---|---|---|---|---|---|---|---|---|
| 2 | distributed | 0.78 ± 0.19 | 0.015 ± 0.003 | 98 ± 14 | 138 ± 53 | 0.37 ± 0.11 | 4.7 ± 1.2 | 1.0 ± 0.2 |
| 2 | centralized | 0.78 ± 0.19 | 0.015 ± 0.003 | 97 ± 15 | 137 ± 53 | 0.37 ± 0.11 | 5.3 ± 1.0 | 0.9 ± 0.1 |
| 4 | distributed | 0.97 ± 0.05 | 0.030 ± 0.005 | 93 ± 17 | 129 ± 38 | 0.35 ± 0.06 | 4.7 ± 0.4 | 1.2 ± 0.2 |
| 4 | centralized | 0.97 ± 0.05 | 0.030 ± 0.005 | 96 ± 18 | 147 ± 53 | 0.35 ± 0.06 | 6.1 ± 1.5 | 1.1 ± 0.2 |
| 8 | distributed | 0.98 ± 0.03 | 0.056 ± 0.009 | 85 ± 8 | 103 ± 13 | 0.32 ± 0.06 | 6.8 ± 0.4 | 1.9 ± 0.2 |
| 8 | centralized | 1.00 | 0.057 ± 0.010 | 86 ± 2 | 108 ± 7 | 0.32 ± 0.06 | 4.4 ± 0.4 | 1.7 ± 0.1 |
| 16 | distributed | 0.30 ± 0.17 | 0.015 ± 0.010 | 72 ± 3 | 84 ± 13 | 0.09 ± 0.02 | 7130.1 ± 113.4 | 3.1 ± 0.1 |
| 16 | centralized | 1.00 | 0.103 ± 0.024 | 81 ± 2 | 104 ± 3 | 0.29 ± 0.07 | 4.9 ± 0.5 | 3.5 ± 0.1 |
...
- **At N = 16 the _distributed_ arm degrades** (completion 30%, T_claim 7130 ms) while centralized holds (100%, 5 ms): Context-Fabric's all-to-all LF proposal mesh (replicated, strongly-consistent task state) hits its centralized-RTI control-plane limit here, which a single federate has no reason to. **On raw service metrics at workstation scale, centralized matches or exceeds distributed.**
